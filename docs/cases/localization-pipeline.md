...
### Цель
Разработать автоматизированный двусторонний конвейер данных (ETL Pipeline) для сборки, глубокой трансформации, семантической разметки и подготовки пакетов локализации к деплою в Weblate в режиме «одной кнопки».
